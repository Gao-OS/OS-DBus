defmodule GaoBusWebWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, html: {GaoBusWebWeb.Layouts, :root}
  ...
  # scope "/api", GaoBusWebWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard in development
  if Application.compile_env(:gao_bus_web, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: GaoBusWebWeb.Telemetry
    end
  end
end
